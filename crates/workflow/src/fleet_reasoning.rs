...
pub struct ReasoningCapability {
    ...
    /// routes also **collapse interior tiers**: Nestlone's own route
...
impl ResolvedReasoning {
    ...
    /// The tier the selector landed on. This is a Nestlone-side selector
...
mod tests {
    ...
    /// and a ceiling. Nestlone's own route normalizer coerces `low` and
