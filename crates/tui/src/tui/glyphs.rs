//! Nestlone's terminal glyph charter.
//!
...
//! Nestlone anchor: it marks the active speaker or current human choice.
...
/// Reduce a single Nestlone-authored decorative glyph to narrow ASCII.
