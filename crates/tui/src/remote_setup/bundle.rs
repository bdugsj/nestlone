...
fn render_runtime_env(i: &BundleInputs) -> String {
    ...
    out.push_str("# Codewhale runtime config — generated by `nestlone remote-setup`.\n");
...
fn render_bridge_env(i: &BundleInputs) -> String {
    let mut out = String::new();
    out.push_str(&format!(
        "# Codewhale {} bridge config — generated by `nestlone remote-setup`.\n",
        i.bridge.display
    ));
...
PrivateTmp=true\n\
ProtectSystem=full\n\
ReadWritePaths=/home/nestlone/.codewhale /home/nestlone/.deepseek {workspace}\n\n\
[Install]\n\
