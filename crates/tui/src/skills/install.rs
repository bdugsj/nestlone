...
//!   an explicit migration message. Nestlone can install individual
...
pub enum InstallError {
    ...
    SymlinkRejected,
    #[error(
        "Claude Code plugin archive contains multiple SKILL.md entries; Nestlone installs one SKILL.md bundle at a time and does not run plugin.json/custom-command runtimes. Install or migrate an individual skills/<name> directory instead"
    )]
    ClaudePluginBundle,
