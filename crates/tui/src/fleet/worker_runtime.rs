...
fn fleet_task_prompt_with_profile(
    ...
    prompt.push_str("You have been summoned as a Nestlone Fleet member (");
...
mod tests {
    ...
    fn fleet_task_prompt_includes_instructions_context_and_input_files() {
        ...
        assert!(prompt.contains("summoned as a Nestlone Fleet member (general)"));
    ...
    fn fleet_worker_spec_resolves_agent_profile_role_prompt_and_loadout() {
        ...
        assert!(
            spec.objective
                .contains("summoned as a Nestlone Fleet member (reviewer)")
        );
