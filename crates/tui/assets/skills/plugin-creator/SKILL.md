---
name: plugin-creator
description: Scaffold a local Nestlone plugin bundle with a versioned manifest, namespaced Skills, and an explicit trust review.
---

# Plugin Creator

Use this skill when a user wants a local Nestlone plugin bundle. Nestlone
...
1. Pick a Nestlone-owned location:
   - User bundle: `~/.nestlone/plugins/<plugin-name>/`
   - Workspace bundle: `<workspace>/.nestlone/plugins/<plugin-name>/`
...
4. Put each Skill under `skills/<skill-name>/SKILL.md`. Nestlone exposes it
