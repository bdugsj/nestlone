...
pub enum Currency {
    ...
    Usd,
    Cny,
    /// An ISO-4217-style code Nestlone does not special-case.
    Other(String),
}
...
/// this age Nestlone stops calling the row authoritative rather than billing
...
/// Upper bound, per million tokens, on a price Nestlone will treat as real.
///
