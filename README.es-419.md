...
Nestlone empezó como una experiencia nativa para DeepSeek. Desde entonces se ha
...
Trabaja de forma interactiva en la TUI, o ejecuta `nestlone exec` en scripts y
...
![Nestlone ejecutándose en una terminal](assets/screenshot.png)
...
- **Solo lectura hasta que permitas más.** El modo Plan no cambia archivos, y
  ...
  sistema operativo realmente envuelve un comando, Nestlone lo indica: Seatbelt
...
- [docs/HOOKS.md](docs/HOOKS.md) — los once eventos de hooks del ciclo de vida
  de la TUI, sus payloads y los tres que pueden dirigir un turno (`nestlone
...
- [Issues abiertos](https://github.com/bdugsj/nestlone/issues) — las buenas
