...
Nestlone khởi đầu là một trải nghiệm gốc (native) cho DeepSeek. Từ đó, nó đã
...
trong TUI, hoặc chạy `nestlone exec` trong script và CI. Viết bằng Rust, giấy
...
![Nestlone chạy trong terminal](assets/screenshot.png)
...
- **Chỉ đọc cho tới khi bạn cho phép thêm.** Chế độ Plan không đổi file, và mọi
  ...
  lệnh, Nestlone nói rõ điều đó: Seatbelt trên macOS khi khả dụng, bubblewrap
...
- [docs/HOOKS.md](docs/HOOKS.md) — mười một sự kiện hook trong vòng đời TUI,
  payload của chúng và ba sự kiện có thể điều hướng một lượt (`nestlone exec`
...
- [Issue đang mở](https://github.com/bdugsj/nestlone/issues) — những đóng góp
...
[![Biểu đồ Star History](https://api.star-history.com/chart?repos=bdugsj/nestlone&type=date&legend=top-left)](https://www.star-history.com/?repos=bdugsj%2Fnestlone&type=date)
