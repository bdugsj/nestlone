...
export class RuntimeStatusView implements vscode.WebviewViewProvider {
  public static readonly viewType = "nestlone.runtimeStatus";
  ...
  resolveWebviewView(view: vscode.WebviewView): void {
    ...
    view.webview.onDidReceiveMessage((message: { command?: string }) => {
      if (message.command === "check") {
        ...
        void vscode.commands.executeCommand("nestlone.startRuntime");
      } else if (message.command === "terminal") {
        void vscode.commands.executeCommand("nestlone.openTerminal");
      } else if (message.command === "threads") {
        void vscode.commands.executeCommand("nestlone.refreshAgentView");
      } else if (message.command === "snapshots") {
        void vscode.commands.executeCommand("nestlone.refreshSnapshots");
      }
    });
    this.render();
  }
...
<body>
  ...
  <button data-command="terminal">Open Nestlone Terminal</button>
