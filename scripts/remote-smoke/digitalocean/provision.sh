#!/usr/bin/env bash
# EXPERIMENTAL — DigitalOcean smoke-lab provisioning for the Nestlone
...
#
# Tunables (env):
#   DROPLET_NAME    default nestlone-smoke
...
DROPLET_NAME="${DROPLET_NAME:-nestlone-smoke}"
