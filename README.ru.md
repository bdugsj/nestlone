...
Nestlone начинался как нативный клиент для DeepSeek. С тех пор он вырос в проект,
...
`/model`. Работайте интерактивно в TUI или запускайте `nestlone exec` в скриптах
...
[English](README.md) · [简体中文](README.zh-CN.md) · [日本語](README.ja-JP.md) · [Tiếng Việt](README.vi.md) · [Bahasa Indonesia](README.id.md) · [한국어](README.ko-KR.md) · [Español](README.es-419.md) · [Português](README.pt-BR.md) · [Українська](README.uk.md) · [codewhale.net](https://codewhale.net/) · [Docs](docs) · [Changelog](CHANGELOG.md)
...
![Nestlone, запущенный в терминале](assets/screenshot.png)
...
- **Только чтение, пока вы не разрешите больше.** Режим Plan не может изменять
  ...
  оборачивает песочница ОС, Nestlone сообщает об этом: Seatbelt на macOS, где он
...
- [docs/HOOKS.md](docs/HOOKS.md) — одиннадцать событий хуков жизненного цикла
  TUI, их полезная нагрузка и три из них, способные направлять ход (`nestlone
...
- [Открытые задачи](https://github.com/bdugsj/nestlone/issues) — здесь живут
