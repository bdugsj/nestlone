...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata({
    path: "/contribute",
    locale,
    title: isZh ? "参与贡献 · Nestlone" : "Contribute · Nestlone",
    description: isZh
      ? "提交 issue、改进翻译和文档、发送 pull request，参与 Nestlone 国际开源社区。"
      : "File issues, improve translations and documentation, and send pull requests to the international Nestlone community.",
  });
}
...
const stepsEn = [
  {
    ...
    cta: { label: "Browse open issues", href: "https://github.com/bdugsj/nestlone/issues" },
  },
  {
    n: "02",
    ...
    cta: { label: "Open the repository", href: "https://github.com/bdugsj/nestlone" },
  },
  {
    n: "03",
    ...
    cta: { label: "Read the contributor guide", href: "https://github.com/bdugsj/nestlone/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "04",
    ...
    cta: { label: "View open pull requests", href: "https://github.com/bdugsj/nestlone/pulls" },
  },
];
...
const stepsZh = [
  {
    ...
    cta: { label: "浏览 open issues", href: "https://github.com/bdugsj/nestlone/issues" },
  },
  {
    n: "02",
    title: "Fork 并创建分支",
    body: "克隆你的 fork，并使用简短的分支名，例如 fix/provider-timeout 或 docs/fleet-example。无关修改请拆成不同的 pull request。",
    cta: { label: "打开仓库", href: "https://github.com/bdugsj/nestlone" },
  },
  {
    n: "03",
    title: "测试你修改的行为",
    body: "先运行最小相关测试，再执行格式检查和你所修改部分需要的更完整检查。",
    cta: { label: "阅读贡献指南", href: "https://github.com/bdugsj/nestlone/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "04",
    title: "在 PR 中说明结果",
    body: "说明问题、修改原因、已运行的检查和剩余风险；如果已有 issue，请在 PR 中关联。",
    cta: { label: "查看 open pull requests", href: "https://github.com/bdugsj/nestlone/pulls" },
  },
];
...
export default async function ContributePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const paths = isZh
    ? [
        {
          title: "报告 bug 或兼容性问题",
          body: "提供系统信息、Nestlone 版本、复现步骤、期望行为和可公开的日志。",
          label: "提交 issue",
    ...
    : [
        {
          ...
          body: "Include your system, Nestlone version, reproduction steps, expected behavior, and any logs you can share safely.",
          label: "File an issue",
          href: "https://github.com/bdugsj/nestlone/issues/new/choose",
        },
        {
    ...
    <div className="contribute-page">
      <section className="community-welcome">
        ...
        <div className="portal-container community-welcome-inner">
          ...
          <p>
            {isZh
              ? "Nestlone 欢迎来自不同国家、语言、平台和经验水平的贡献者。清楚的 bug 报告、复现结果、文档修正、翻译和小而完整的代码补丁都会直接帮助项目。"
              : "Nestlone welcomes contributors across countries, languages, platforms, and experience levels. Clear bug reports, reproduction results, documentation corrections, translations, and small complete patches all move the project forward."}
          </p>
          <div className="portal-actions">
            ...
            <Link href="https://github.com/bdugsj/nestlone/blob/main/CONTRIBUTING.md" className="portal-button portal-button-secondary">
