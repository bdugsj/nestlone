...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata({
    path: "/constitution",
    locale,
    title: isZh ? "三层法 · Nestlone" : "Three layers of law · Nestlone",
    description: isZh
      ? "Nestlone 的嵌套宪法：内置基础法、你的常备法（/constitution）、仓库自己的法（.nestlone/constitution.json）。位阶由执行框架强制生效，换掉模型也不失效。"
      : "Nestlone's nested constitution: bundled base law, your standing law (/constitution), and your repo's law (.nestlone/constitution.json). Rank is enforced in the harness and survives a model swap.",
  });
}
...
const LAYERS = [
  ...
  },
  {
    ...
    path: "$NESTLONE_HOME/constitution.json",
    pathZh: "$NESTLONE_HOME/constitution.json",
  ...
  },
  {
    ...
    path: ".nestlone/constitution.json",
    pathZh: ".nestlone/constitution.json",
