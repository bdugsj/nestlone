 ...
 *
 *   "Shipped"    ← last 8 published Releases on bdugsj/nestlone
 ...
 */
const REPO = process.env.GITHUB_REPO ?? "bdugsj/nestlone";
...
async function gh<T>(url: string, ghToken?: string): Promise<T | null> {
  const headers: Record<string, string> = {
    ...
    "User-Agent": "nestlone-web-roadmap",
...
const FALLBACK_SHIPPED: RoadmapItem[] = [
  {
    ...
    href: "https://github.com/bdugsj/nestlone/releases/tag/v0.8.45",
  },
];
