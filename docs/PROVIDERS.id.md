...
Registri ini menjelaskan perilaku penyedia (provider) yang terhubung ke dalam basis kode Nestlone saat ini. Registri ini sengaja dibuat konservatif: entri yang dirilis terbatas pada ID penyedia, kunci konfigurasi, jalur autentikasi, URL dasar, resolusi model, dan metadata kapabilitas yang sudah dikelola oleh sistem.
