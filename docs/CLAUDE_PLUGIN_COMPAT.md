...
Nestlone treats Claude Code skill folders as instruction bundles when they are
...
a Nestlone skill that names the external command explicitly.

Nestlone's own versioned plugin bundles are a different, explicitly trusted
