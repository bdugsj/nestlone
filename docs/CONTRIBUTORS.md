...
Nestlone is built in the open with a growing community of contributors. Every
...
[GitHub contributors page](https://github.com/bdugsj/nestlone/graphs/contributors),
[`AUTHOR_MAP`](https://github.com/bdugsj/nestlone/blob/main/.github/AUTHOR_MAP),
...
- **[OpenWarp](https://github.com/zerx-lab/warp)** — for prioritizing Nestlone support and collaborating on a better terminal-agent experience.
...
<details open>
<summary><strong>v0.0.2 — nestlone rebrand</strong></summary>

The first Nestlone release. The fork was rebranded from Codewhale end to end,
release engineering moved fully to GitHub Actions, and community PRs and issue
reports were merged or harvested into the new release lane.

**Merged / harvested contributors:**

- **[greyfreedom](https://github.com/greyfreedom)**
- **[nightt5879](https://github.com/nightt5879)**
- **[XhesicaFrost](https://github.com/XhesicaFrost)**
- **[cyq1017](https://github.com/cyq1017)**
- **[snail-vs](https://github.com/snail-vs)**
- **[SparkofSpike](https://github.com/SparkofSpike)**
- **[GTC2080](https://github.com/GTC2080)**
- **[h3c-hexin](https://github.com/h3c-hexin)**
- **[atmosuwiryo](https://github.com/atmosuwiryo)**
- **[M-Maciej](https://github.com/M-Maciej)**
- **[raphamorim](https://github.com/raphamorim)**
- **[LI-Jialu](https://github.com/LI-Jialu)**
- **[kobihikri](https://github.com/kobihikri)**
- **[EvanProgramming](https://github.com/EvanProgramming)**
- **[adity982](https://github.com/adity982)**
- **[vibecoding-skills](https://github.com/vibecoding-skills)**

**Issue helpers:**

- **[fleitz](https://github.com/fleitz)**
- **[LmeSzinc](https://github.com/LmeSzinc)**
- **[antarikshraya](https://github.com/antarikshraya)**
- **[eugenicum](https://github.com/eugenicum)**
- **[whp233](https://github.com/whp233)**
...
- **[cy2311](https://github.com/cy2311)**
- **[wywsoor](https://github.com/wywsoor)**
</details>
...
- **[Chavdar Ivanov / ci4ic4](https://github.com/ci4ic4)** — NetBSD QuickJS
  bindgen support for nestlone-workflow-js (PR #4349)
...
- **[gaord](https://github.com/gaord)** — add the community-maintained
  Nestlone for VS Code GUI frontend to the English and Chinese READMEs (#4035)
...
- **[noaft](https://github.com/noaft)** — `/links` provider docs fallback
  update, including the current Nestlone docs URL and a Baidu Qianfan docs
  link (#3621, harvested)
...
- **[nightt5879](https://github.com/nightt5879)** — keep the onboarding marker in
  the nestlone home view (#3302) and branch-hygiene check hardening (#3348)
...
sibling), added TOML comment preservation and the Nestlone-only skill discovery
...
- **[nightt5879](https://github.com/nightt5879)** — Nestlone-only skill discovery
  gate (`[skills].scan_nestlone_only`) ignoring cross-tool directories (#3296) and
...
- **[xyuai](https://github.com/xyuai)** — canonical Nestlone settings path,
...
- **[mac119](https://github.com/mac119)** and **[leo119](https://github.com/leo119)** — `nestlone update` command documentation (#838, #917)
...
- **[zlh124](https://github.com/zlh124)** — WSL2/headless startup report, clipboard-init fix, Nestlone tab-title polish, localized context-menu labels, and approval-dialog fixes (#1772, #1773, #2319, #2320, #2325)
...
- **[xin1104](https://github.com/xin1104)** — Homebrew nestlone binary install (#2105)
...
- **[cy2311](https://github.com/cy2311)** — Windows `.bat` launcher for Nestlone (#1861)
