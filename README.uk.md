...
Nestlone починався як нативний інструмент для DeepSeek. Відтоді він виріс у
...
командою `/model`. Працюйте інтерактивно в TUI або запускайте `nestlone exec`
...
![Nestlone працює в терміналі](assets/screenshot.png)
...
- **Лише читання, доки ви не дозволите більше.** Режим Plan не може змінювати
  ...
  справді обгортає команду, Nestlone каже про це: Seatbelt на macOS, де він
...
- [docs/HOOKS.md](docs/HOOKS.md) — одинадцять подій хуків життєвого циклу TUI,
  їхні корисні навантаження та три з них, що можуть скеровувати хід (`nestlone
...
- [Відкриті issues](https://github.com/bdugsj/nestlone/issues) — тут живуть
  хороші перші внески
