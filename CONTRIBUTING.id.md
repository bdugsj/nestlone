# Berkontribusi pada Nestlone

Terima kasih atas minat Anda untuk berkontribusi pada Nestlone! Dokumen ini memberikan panduan dan instruksi untuk berkontribusi.
...
1. Fork dan klon repositori:
   ```bash
   git clone https://github.com/USERNAME_ANDA/Nestlone.git
   cd Nestlone
   ```
